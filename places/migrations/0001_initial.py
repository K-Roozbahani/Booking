    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotel_room_attribute', to='places.hotelroom', verbose_name='room')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modify', models.DateTimeField(auto_now=True, verbose_name='last modify')),
                ('description', models.CharField(blank=True, max_length=64, null=True, verbose_name='description')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accommodation_room_attribute', to='places.accommodationroom', verbose_name='room')),
            ],
            options={
