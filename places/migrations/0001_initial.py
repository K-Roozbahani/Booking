# Generated by Django 4.1.4 on 2023-01-10 09:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_numbers', models.PositiveIntegerField(verbose_name='person number')),
                ('extra_price', models.FloatField(blank=True, null=True, verbose_name='extra price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_type', models.ManyToManyField(related_name='accommodation', to='places.locationtype', verbose_name='location type')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Accommodation', to=settings.AUTH_USER_MODEL, verbose_name='Accommodation')),
            ],
            options={
                'verbose_name': 'Place',
